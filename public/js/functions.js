          ...
          if (intRegex.test(productQuantity)) {
            ...
            $(".custom-cart")
              ...
              .each(function () {
                ...
                console.log(num);
                let ticketTotal = Number(price) * Number(num);

                total = Number(total) + Number(ticketTotal);
              });

            $(".cart-input").val(String(total));
            $(".custom-pay-btn").text(String(total));
          } else {
        ...
        .on("click", function () {
          ...
          if (intRegex.test(productQuantity)) {
            if (Number(productQuantity) > 0) {
              ...
              $(".custom-pay-btn").val(String(total));
              $(".custom-pay-btn").text(String(total));
            }
          } else {
            $(this).parents(".quantity").find(".qty").val(Number(quantityStep));
